...
- MCP는 AI와 외부 서비스 연동에 유용하지만, 지금 당장 바이브 코딩의 필수 조건은 아니다.
- CLI는 오래 검증된 범용 인터페이스이며, AI가 깃, 클라우드, IaC, 데이터베이스 작업을 수행하게 만드는 실용적인 통로가 된다.
- MCP 생태계와 보안 운영이 더 성숙하기 전까지는 익숙한 CLI를 적극 활용하는 것이 현실적인 선택이다.
