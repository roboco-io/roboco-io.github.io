...
- README/AGENTS.md에 `Confidential`, `Private`, `비공개`, `대외비` 표시
...
선택된 각 프로젝트에 대해, README/AGENTS.md/INTENT.md 를 근거로 **2~3문장 소개 문구 초안**을 생성한 뒤, 사용자에게 확인받는다. 옵션: 초안 그대로 / 약간 수정(Other) / 빼기.
